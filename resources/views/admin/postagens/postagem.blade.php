...
<section class="text-center">
    <div class="img-responsive">
        <img src="{{ isset($posts) ? $posts->image_1 : url('adm/img/erro_img_post.jpg') }}" style="width: 85%; height:500px;">
    </div>
</section>
@endsection
@section('content')
    ...
    <div class="row" style="margin-top: -100px;">
        ...
        <div class="col-md-12 px-lg-5">
            ...
            <div class="card pb-5 mx-md-3">
                                ...
                                <form>
                                    ...
                                    <div class="row mb-2 mt-4 text-center">
                                        ...
                                        <div class="col-md-12 my-4">
                                            <img src="{{ $posts->image_2 or '#' }}" class="img-fluid z-depth-1 img-responsive" alt="sample image">
                                        </div>
                                        <!--Grid column-->
                                    </div>
                                    <!--Grid row-->
                ...
                <a name="voltar" id="" class="btn btn-info" href="{{ Request::redirect()->back() }}" role="button">Voltar</a>
                @endif
                <!--Grid row-->
...
<script>
    $(document).ready(function() {
        toastr.error("{{ $errors }}", "Alerta", {
            "positionClass": "toast-top-right",
        });
    });
</script>
@endif @if(isset($success) && count($success)>0)
<script>
    $(document).ready(function() {
